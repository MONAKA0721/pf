...
const careers = [
  {
    ...
    description: `業務委託開発
                  オンラインゲームにおけるフレンドマッチングに新しい体験をもたらす新サービス開発にバックエンドエンジニアとして関わっています`,
  },
  {
    date: '2020/9',
    company: 'teamLab Inc.',
  ...
  },
  {
    ...
    description: `京都開発拠点長期インターン
                  KTA(京都開発本部テクニカルアーキテクトグループ)で Go を中心技術とした性能改善を行っています`,
  },
  {
    date: '2020/4',
    company: 'クックパッド株式会社',
  ...
  },
  {
    ...
    company: '株式会社HACARUS',
    description: `長期インターン
                  機械学習を用いたプロダクトのデモWebアプリ作成や各プロジェクトの CI 整備を担っています`,
  },
  {
    date: '2019/9',
    company: '株式会社オプティム',
